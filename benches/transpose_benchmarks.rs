...
fn bench_transpose_inplace(b: &mut test::Bencher, width: usize, height: usize) {
...
#[bench] fn bench2_inplace_u32_0004x0004(b: &mut test::Bencher) { bench_transpose_inplace(b, 4, 4); }
#[bench] fn bench2_inplace_u32_0008x0008(b: &mut test::Bencher) { bench_transpose_inplace(b, 8, 8); }
#[bench] fn bench2_inplace_u32_0016x0016(b: &mut test::Bencher) { bench_transpose_inplace(b, 16, 16); }
#[bench] fn bench2_inplace_u32_0064x0064(b: &mut test::Bencher) { bench_transpose_inplace(b, 64, 64); }
#[bench] fn bench2_inplace_u32_0256x0256(b: &mut test::Bencher) { bench_transpose_inplace(b, 256, 256); }
#[bench] fn bench2_inplace_u32_1024x1024(b: &mut test::Bencher) { bench_transpose_inplace(b, 1024, 1024); }
#[bench] fn bench2_inplace_u32_4096x4096(b: &mut test::Bencher) { bench_transpose_inplace(b, 4096, 4096); }